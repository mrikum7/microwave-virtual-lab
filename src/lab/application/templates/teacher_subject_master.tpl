    ...
    <table width="1002" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td id="panel_bg"><div id="container">
          ...
          <div class="gap"></div>
          <div class="rows">
            <table width="944" border="0" cellspacing="6" cellpadding="6">
              <tr>
                <td width="640" valign="top">
                <div class="panel_content">
                <form action="teacher_subject_master_exec.php" method="post" id="qustForm" name="qustForm" >
                ...
                <tr>
                  ...
                  <td><select multiple="multiple" size="4" name="subject_id[]" id="subject_id">
                ...
                <tr>
                <td colspan="2" align="center"><input name="submit" type="submit" class="submit_btn2" id="submit" value="Submit" /> </td>
                </tr>
                </table>
                </form>
                </div>
