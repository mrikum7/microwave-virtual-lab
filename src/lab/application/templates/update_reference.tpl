    ...
    <table width="90%" border="0" cellpadding="6" cellspacing="6" class="panel1">
        ...
        <tr>
         ...
         <tr>
           ...
           <td>
             <input name="reference_title" type="text" class="validate[required] textbox" id="reference_title" value="{$data.reference_title}" />
            </td>
         </tr>
         <tr>
          <td valign="top"><strong> Reference Description  :</strong></td>
          <td><label>
              <textarea name="reference_description" rows="10" cols="80"  class="ckeditor" id="desc">{$data.reference_description|stripslash}</textarea>
            </label></td>
        </tr>
         ...
         <tr>
          <td>&nbsp;<input type="hidden" name="reference_id" id="reference_id" value="{$data.reference_id}" />
