...
class Smarty extends Smarty_Internal_Data {
    ...
    { 
		...
		*/
		$this->template_dir = array(APPLICATION_COMP_DIR . 'templates/');
        $this->compile_dir = APPLICATION_COMP_DIR . 'templates_c/';
        $this->cache_dir = APPLICATION_COMP_DIR . 'cache/';
        $this->config_dir = APPLICATION_COMP_DIR . 'configs/';
